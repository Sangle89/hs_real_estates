    ...
    width:48px;
        ...
        <section class="main-content">
            <div class="container">
                ...
                <div class="tab-links">
                    <a class="active" href="<?=base_url('dang-nhap')?>">đăng nhập</a>
                ...
                <?php echo form_open(site_url('dang-nhap'), array('id'=>'loginform', 'method'=>'post')); ?>
                            ...
                            ?>
                                ...
                                <div class="form-group">
                                    <div class="pull-left"><label><input type="checkbox" />&nbsp;Ghi nhớ mật khẩu</label></div>
                                    <div class="pull-right"><a href="<?=site_url('quen-mat-khau')?>" rel="nofollow" style="text-decoration: underline;" rel="nofollow">Quên mật khẩu ?</a></div>
                                    <div class="clearfix"></div>
                                    <div class="text-center" style="margin-top: 15px;">
                                    <input type="submit" value="Đăng nhập" class="btn btn-primary" style="margin: 0 auto;">
