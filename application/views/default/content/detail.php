    ...
    <div class="main-wrap-content property_listing <?php if(USERTYPE == 'Mobile') echo 'mobile_list'?>">
        <div class="property_type row">
            ...
            <?php endif ?>
                ...
                <?php $this->load->view('default/require/content_detail_adv_bottom'); ?>
                ...
                <div class="row">
                    <div class="col-xs-4">
                       <a href="<?=site_url($category['alias'].'/'.$contents[$i]['alias'])?>" class="thumbnail" style="margin-bottom: 0;"><img src="<?=base_url()?>uploads/contents/<?=$contents[$i]['image']?>" alt="<?=$contents[$i]['title']?>" class="img-responsive"/></a> 
                    </div>
                    <div class="col-xs-8">
                        <h3 style="margin: 7px 0;font-size:14px;font-weight:normal;"><a style="color: #000;" href="<?=site_url($category['alias'].'/'.$contents[$i]['alias'])?>"><?=$contents[$i]['title']?></a></h3>
                    </div>
