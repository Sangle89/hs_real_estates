...
$sort_order = isset($post['sort_order']) ? $post['sort_order'] :  $this->district_model->_Get_Max_Sort_Order() + 1;
	...
	<div class="row">
		<article class="col-xs-12 col-sm-12 col-md-12 col-lg-12 sortable-grid ui-sortable">
            <?php 
                ...
                $action = isset($post['id']) ? admin_url($this->uri->segment(2).'/change/'.$post['id']) : admin_url($this->uri->segment(2).'/add/'.$this->uri->segment(4));
                ...
                $this->table->add_row(array(
                    'Đường phố',
                    form_dropdown('streets[]', $street_option, $district_street, 'class="form-control select2" multiple')
                ));
                $this->table->add_row(array(
