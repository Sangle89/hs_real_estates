	...
	<div class="row">
        ...
        <?php 
            ...
            $this->table->add_row(array(
                array('data' => _Input('search_input', '', 'form-control', 'id="searchInput" data-type="search_ward" placeholder="Nhập từ khóa cần tìm.."'), 'colspan'=>5)
            ));
            ...
            foreach($category as $val) {
                ...
                $this->table->add_row(
                    array(
                        ...
                        array('data'=> _Show_Status('wards',$val['id'],'status', $val['status']), 'class'=>'center'),
