	...
	<div class="row">
		<article class="col-xs-12 col-sm-12 col-md-12 col-lg-12 sortable-grid ui-sortable">
            <?php 
                ...
                echo form_open_multipart(admin_url('user/profile'), array('method'=>'post','id'=>'myForm', 'class'=>'smart-form')); 
                ...
                $this->table->add_row(
                    array('data'=>'Phone', 'width' => '20%'),
                    array('data' => form_input($phone).form_error('phone'))
                );
                $this->table->add_row(
                    array('data'=>'Address', 'width' => '20%'),
                    array('data' => form_input($address).form_error('address'))
                );
                $img_avatar = ($cur_avatar!='') ? '<img src="'.base_url('public/uploads/users/thumbs/' . $cur_avatar).'">':'';
                $this->table->add_row(
