                ...
                <tbody>
                    ...
                    <tr id="row<?=$val['id']?>">
                        ...
                        <td><a href="<?=site_url($val['alias'])?>" target="_blank" title="Xem chi tiết"><?php echo $val['title']?></a><br />
                            ...
                            <a href="<?=admin_url('real_estate/featured/'.$row['id'].'/hide')?>" class="label label-success">Nổi bật</a>
                            <?php else: ?>
                            <a href="<?=admin_url('real_estate/featured/'.$row['id'].'/active')?>" class="label label-danger">Không nổi bật</a>
                            <?php endif; ?>
                        </td>
                        ...
                        <td class="center">
                        <a title="Sửa" href="<?=admin_url($this->uri->segment(2) . '/change/' . $val['id'])?>"><i class="fa fa-pencil"></i></a>&nbsp&nbsp;
                        <a title="Xóa" href="<?=admin_url($this->uri->segment(2) . '/delete/' . $val['id'])?>" onclick="return confirmDelete();"><i class="fa fa-trash"></i></a>
                        </td>
                    </tr>
                    <?php endforeach; 
                    else:
