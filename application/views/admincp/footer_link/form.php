...
$dropdown_position = array(
	0 => "--Chọn vị trí hiển thị--",
	1 => "Nhóm liên kết ở Footer",
	2 => "Nhóm liên kết ở cuối trang"
);
?>
        ...
        <article class="col-xs-12 col-sm-12 col-md-12 col-lg-12 sortable-grid ui-sortable">
            <?php 
             ...
             $action = $id ? admin_url($this->uri->segment(2) . '/change/'.$id) : admin_url($this->uri->segment(2) . '/add');
                ...
                $this->table->add_row(
                    array('data'=>'Vị trí hiển thị', 'width' => '20%'),
                    array('data' => _Dropdown('position', $dropdown_position, $position))
                );
