		...
		<article class="col-xs-12 col-sm-12 col-md-12 col-lg-12 sortable-grid ui-sortable">
            ...
            if(validation_errors()) echo '<div class="alert alert-danger fade in">'.validation_errors().'</div>';
                ...
                $this->table->add_row(
                    ...
                    array('data' => _Input('meta_title', $post['meta_title']).form_error('meta_title'))
                );
                ...
                $this->table->add_row(array(
                    'Thuộc danh mục',
                    _Dropdown('parent_id', $main_category, $post['parent_id'])
                ));
                $this->table->add_row(
                    array(
                        'Nội dung',
                ...
                echo widget_submit(array(_Submit('save', 'Lưu lại','save')));
                echo form_close(); 
                ?>
		</article>
	</div>
