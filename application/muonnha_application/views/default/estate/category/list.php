        ...
        <div class="property_type row">
						...
						<div class="col-md-6 col-xs-12 single_properties <?=$class?>">
							...
							<div class="properties_details">
								<div class="img_holder">
									<a href="<?=site_url($result['alias'])?>" title="<?=$result['title']?>"> <img class="lazy" data-src="<?=base_url($image_resize)?>" src="" onerror="this.src='<?=base_url('theme/images/thumb.jpg')?>'" alt="<?=$result['title']?>" class="img-responsive"></a>
        	                   </div> <!-- End .img_holder -->
            ...
            <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
                <div class="sidebar_style_two">
                    ...
                    <?php $this->load->view('default/estate/category/filter_price'); ?>     
                    <?php $this->load->view('default/estate/category/filter_area'); ?>                         
