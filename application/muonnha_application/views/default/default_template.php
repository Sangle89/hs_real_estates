...
<?php endif; ?>
    ...
    <div class="boxed_wrapper">
        ...
        <div class="btnfixedpost" style="display: none;"><a href="/dang-tin-cho-thue-nha.htm" rel="nofollow"><img id="sm" src="/theme/images/buttonfly-miniv2.png">
		...
		<script type="text/javascript" src="<?=base_url()?>theme/js/app.js?v=1.0"></script>
