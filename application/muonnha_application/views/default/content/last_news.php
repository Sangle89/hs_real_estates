                                ...
                                <div class="row">
                                    ...
                                    <h3 style="min-height: inherit;"><a href="<?=site_url($result['category_alias'].'/'.$result['alias'])?>" title="<?=$result['title']?>"><?=sub_string($result['title'],60)?></a></h3>
        								...
        								<div class="col-md-4 col-xs-4 img_holder">
        									<a href="<?=site_url($result['category_alias'].'/'.$result['alias'])?>" title="<?=$result['title']?>"> <img src="<?=base_url('timthumb.php?image='.$result['image'].'&w=200&h=200&zc=1&folder=contents')?>" onerror="this.src='<?=base_url('theme/images/thumb.jpg')?>'" alt="<?=$result['title']?>" class="img-responsive"></a>
                	                   </div> <!-- End .img_holder -->
