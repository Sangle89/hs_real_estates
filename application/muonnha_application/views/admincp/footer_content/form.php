...
$show_project = isset($post['show_project']) ? $post['show_project'] : 0;
            ...
            <?php 
             ...
             $action = $id ? admin_url($this->uri->segment(2) . '/change/'.$id) : admin_url($this->uri->segment(2) . '/add');
                ...
                <table class="table">
                    ...
                    <tr>
                        <td>Hiện trong Dự án</td>
                        <td><input type="checkbox" name="show_project" value="1" <?=$show_project==1?'checked="checked"':''?> /></td>
                    </tr>
                    <tr>
                        <td>Khu vực</td>
                        <td>
                                    ...
                                    <div id="collapse_district_<?=$district['id']?>" class="panel-collapse collapse">
                                        <div class="panel-body">
                                          <div class="panel panel-default">
                                            <div class="panel-heading">
                                                <label><input type="checkbox" name="checkall_ward[<?=$district['id']?>]" />&nbsp;Phường</label>
                                            </div>
                                            <div class="panel-heading">
                                                <label><input type="checkbox" name="checkall_street[<?=$district['id']?>]" />&nbsp;Đường</label>
                                            </div>
                                          </div>    
                                        </div>
                                    </div>
