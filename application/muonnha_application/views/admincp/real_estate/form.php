...
$noithat = isset($post['noithat']) ? $post['noithat'] : '';

$title = isset($post['title']) ? $post['title'] : '';
$keyword = isset($post['keywords']) ? $post['keywords'] : '';
$description = isset($post['description']) ? $post['description'] : '';
$content = isset($post['content']) ? str_replace("<br />","\n", ($post['content'])) : '';
$video = isset($post['video']) ? $post['video'] : '';
$type_id = isset($post['type_id']) ? $post['type_id'] : 4;
	...
	<div class="row">
		<article class="col-xs-12 col-sm-12 col-md-12 col-lg-12 sortable-grid ui-sortable">
            ...
            //if(validation_errors()) echo '<div class="alert alert-danger fade in">'.validation_errors().'</div>';
                $action = isset($post['id']) ? admin_url($this->uri->segment(2) . '/change/'.$post['id']) : admin_url($this->uri->segment(2) . '/add');
                ...
                <div class="row">
                    <div class="col-lg-6 col-md-6">
                        ...
                        <div class="row">
                            <div class="col-lg-6 col-md-6">
                                <div class="form-group">
                                    <label>Giá cho thuê<span class="required">*</span></label>
                        ...
                        <label style="margin-right: 20px;"><?=$utility['title']?> <input type="checkbox" name="utilities[]" value="<?=$utility['id']?>" <?php if(isset($real_estate_utilities) && in_array($utility['id'], $real_estate_utilities)) echo 'checked="checked"';?> /></label>
