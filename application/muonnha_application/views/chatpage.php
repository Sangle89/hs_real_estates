...
<html lang="en">
  <head>
    ...
    <!-- Bootstrap core CSS -->
    <link href="<?php echo base_url();?>asset/chat/css/bootstrap.min.css" rel="stylesheet">
    <!-- Bootstrap theme -->
    <link href="<?php echo base_url();?>asset/chat/css/bootstrap-theme.min.css" rel="stylesheet">
	<!-- Font Awesome core CSS -->
    <link href="<?php echo base_url();?>asset/chat/css/font-awesome/css/font-awesome.min.css" rel="stylesheet">
	<!-- Custom styles for this template -->
    <link href="<?php echo base_url();?>asset/chat/css/theme.css" rel="stylesheet">
  ...
  <body role="document">
    ...
    <script src="<?php echo base_url();?>asset/chat/js/bootstrap.min.js"></script>
	<script type="text/javascript" src="<?php echo base_url();?>asset/chat/js/moment.min.js"></script>
