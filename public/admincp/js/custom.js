...
jQuery(document).ready(function(){
	...
	jQuery('.skin-color').click(function(){
		...
		if(jQuery('#skinstyle').length > 0) {
			if(s!='default') {
				jQuery('#skinstyle').attr('href',base_url + 'public/admin/css/style.'+s+'.css');	
			...
			if(s!='default') {
				jQuery('head').append('<link id="skinstyle" rel="stylesheet" href='+base_url+'"public/admin/css/style.'+s+'.css" type="text/css" />');
				jQuery.cookie("skin-color", s, { path: '/' });
			}
		}
		return false;
