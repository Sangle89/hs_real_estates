...
*/
$baseUrl = 'https://'.$_SERVER['SERVER_NAME']."/public/images/";//trên host bỏ thư mục chưa cau hinh cai nay la xong :D
//$baseUrl = 'http://codeignitercms.local/public/images/';
/*
